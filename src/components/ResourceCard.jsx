...
export default function ResourceCard({ resource }) {
  return (
    <a
      ...
      className="group block p-3.5 sm:p-4 rounded-xl bg-gray-900/50 border border-gray-800/50 hover:border-brand-500/30 hover:bg-gray-900 transition-all duration-200 min-h-[72px]"
    >
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1 flex-wrap">
            <h3 className="font-semibold text-gray-100 group-hover:text-brand-400 transition-colors text-sm leading-tight">
              {resource.name}
            </h3>
