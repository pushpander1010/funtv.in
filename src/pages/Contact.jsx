    ...
    <div className="min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <p className="text-gray-500 mb-10">
          Have a suggestion, question, or want to report a broken link? We'd love to hear from you.
        </p>
        ...
        <div className="space-y-6">
          <div className="p-6 rounded-2xl bg-gray-900/50 border border-gray-800/50">
            ...
            <p className="text-sm text-gray-500">
              For general inquiries, resource suggestions, or takedown requests:
            </p>
            <a
              href="mailto:hello@funtv.in"
              className="inline-flex items-center gap-2 mt-3 text-brand-400 hover:text-brand-300 text-sm font-medium"
            >
              hello@funtv.in
          ...
          <div className="p-6 rounded-2xl bg-gray-900/50 border border-gray-800/50">
            ...
            <p className="text-sm text-gray-500 mb-3">
              Found a great free resource we should list? Send us:
            </p>
          ...
          <div className="p-6 rounded-2xl bg-gray-900/50 border border-gray-800/50">
            ...
            <p className="text-sm text-gray-500">
              If you are a content owner and believe a link on our site infringes on your rights,
              please email us with the specific link and we will remove it promptly.
            </p>
          </div>
        </div>
      </div>
